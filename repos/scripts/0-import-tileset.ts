#!/usr/bin/env node
/**
 * Squad Pod Tileset Import — Complete CLI wrapper for 7-stage asset extraction pipeline
 *
 * Usage:
 *   npx tsx scripts/0-import-tileset.ts
 *
 * This script guides you through the complete process of extracting furniture assets
 * from a tileset PNG file and integrating them into the Squad Pod extension.
 */
...
function displayBanner() {
  ...
  console.log('\n')
  console.log('╔════════════════════════════════════════════════════════════════╗')
  console.log('║              🎨 SQUAD POD TILESET IMPORT PIPELINE 🎨            ║')
...
async function runStage1(tilesetFile: string) {
  ...
  console.log('Output: scripts/.tileset-working/tileset-detection-output.json')
  console.log()

  // Copy tileset to working area if needed
  const tilesetDest = path.join(process.cwd(), 'webview-ui', 'public', 'assets', 'office_tileset_16x16.png')
...
async function runStage2() {
  ...
  console.log('Input: scripts/.tileset-working/tileset-detection-output.json')
  console.log('Output: scripts/.tileset-working/asset-editor-output.json')
  console.log()
  ...
  if (confirm.toLowerCase() === 'y') {
    try {
      ...
      await question('Press Enter when done editing...')
...
async function runStage3() {
  ...
  console.log('Input: scripts/.tileset-working/asset-editor-output.json + office_tileset_16x16.png')
  console.log('Output: scripts/.tileset-working/tileset-metadata-draft.json')
  console.log()
...
async function runStage4() {
  ...
  console.log('Input: scripts/.tileset-working/tileset-metadata-draft.json')
  console.log('Output: scripts/.tileset-working/tileset-metadata-final.json')
  console.log()
  ...
  if (confirm.toLowerCase() === 'y') {
    try {
      ...
      console.log('\n⏳ Editor opened in browser. When finished:')
      await question('Press Enter when done reviewing...')
...
async function runStage5() {
  ...
  console.log('Input: scripts/.tileset-working/tileset-metadata-final.json + office_tileset_16x16.png')
...
async function runPipeline() {
  ...
  console.log('═'.repeat(60))
  console.log()
  console.log('✨ Your tileset assets are now integrated into Squad Pod!')
  console.log()
  console.log('📝 Summary:')
  ...
  while (running) {
    ...
    switch (choice) {
      ...
      case '3': {
        ...
        switch (stage.trim()) {
          case '1':
            await runStage1(await getFileInput('📁 Enter path to tileset PNG file: ', '.png'))
            break
          case '2':
            await runStage2()
            break
