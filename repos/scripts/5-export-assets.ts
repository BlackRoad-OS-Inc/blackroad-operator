 ...
 *
 * Requires:
 *   - scripts/.tileset-working/tileset-metadata-final.json (approved metadata)
 *   - webview-ui/public/assets/office_tileset_16x16.png (source tileset)
 */
...
console.log(`\n✅ Export complete!`)
console.log(`\n📂 Folder structure:`)
console.log(`   webview-ui/public/assets/`)
...
console.log(`   The extension will load assets from furniture-catalog.json\n`)
