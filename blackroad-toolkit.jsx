  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${highlight ? T.border.hover : T.border.card}`,
...
function StatStrip({ stats }) {
  return (
    <div
      style={{
        display: 'grid',
        gridTemplateColumns: `repeat(auto-fill, minmax(${Math.max(100, 400 / stats.length)}px, 1fr))`,
        gap: 1,
        background: T.border.card,
        borderRadius: T.radius.card,
        overflow: 'hidden',
      }}
    >
...
function BRSearch({ placeholder = 'Search...', value, onChange }) {
  return (
    ...
    >
      ...
      />
      <BRButton variant="primary" style={{ padding: '8px 20px', fontSize: 13 }}>
        Search
      </BRButton>
    </div>
  )
  ...
  return (
    <div
      style={{
        ...
        gap: 12,
        padding: '10px 18px',
        borderBottom: divider ? `1px solid ${T.border.subtle}` : 'none',
        flexWrap: 'wrap',
      }}
    >
      ...
      >
        <span
          style={{
            ...
            fontSize: 14,
            fontWeight: 500,
            color: isOpen ? T.text.primary : T.text.tertiary,
          }}
        >
          {question}
        </span>
...
function CodeSnippet({ code }) {
  ...
  return (
    ...
    >
      ...
      >
        <span
          style={{ fontFamily: T.font.mono, fontSize: 10, color: T.text.ghost }}
        >
          JSX
        </span>
        <button
        ...
        <div style={{ padding: '32px 20px 80px' }}>
          <div style={{ maxWidth: T.maxWidth, margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: 40 }}>
              ...
              >
                Every component, token, and pattern used across all 17 BlackRoad
                templates. Copy any piece. Build anything in the ecosystem.
              </p>
            </div>
              ...
              {sections.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 500,
                    color:
                      activeSection === s.id ? T.text.primary : T.text.faint,
                    background:
                      activeSection === s.id ? T.border.card : 'transparent',
                    border: 'none',
            ...
            {activeSection === 'tokens' && (
              <div>
                <Section id="colors">
                  ...
                  >
                    Never on text. Only on bars, dots, dividers, and decorative
                    elements. The palette defines identity without polluting
                    readability.
                  </p>
                  <div
                    style={{
                ...
                <Section id="grays">
                  ...
                  >
                    Every text element in the system uses one of these values.
                    The hierarchy creates depth through luminance, not color.
                  </p>
                  <Card>
                    {[
                      {
                        name: 'primary',
                        hex: '#f5f5f5',
                        use: 'Headlines, emphasis, active states',
                      },
                      {
                        name: 'secondary',
                        hex: '#d4d4d4',
                        use: 'Subheads, card titles, active nav',
                      },
                      {
                        name: 'tertiary',
                        hex: '#a3a3a3',
                        use: 'Body text, data values, labels',
                      },
                      {
                        name: 'muted',
                        hex: '#737373',
                        use: 'Descriptions, paragraphs, snippets',
                      },
                      {
                        name: 'dim',
                        hex: '#525252',
                        use: 'Secondary info, captions',
                      },
                      {
                        name: 'faint',
                        hex: '#404040',
                      ...
                      },
                      {
                        name: 'ghost',
                        hex: '#333333',
                        use: 'Barely visible, section markers',
                      },
                      {
                        name: 'invisible',
                        hex: '#262626',
                        use: 'Separators, near-hidden text',
                      },
                    ].map((g, i, arr) => (
                      <div
                        key={g.name}
                ...
                <Section id="type">
                  ...
                  >
                    <Card style={{ padding: 22 }}>
                      ...
                      >
                        Headlines only. Never body text. Always weight 700.
                    ...
                    <Card style={{ padding: 22 }}>
                      ...
                      >
                        Inter — the workhorse. Body text, descriptions, buttons,
                        navigation labels. Weights 400, 500, 600. Clean and
                        invisible.
                      </div>
                      <div
                        style={{
                      ...
                      >
                        Body font. Weights 400 (body), 500 (buttons, emphasis),
                        600 (rare strong emphasis).
                      </div>
                    </Card>
                    <Card style={{ padding: 22 }}>
                      <div
                      ...
                      >
                        JetBrains Mono — data, labels, code, timestamps, badges,
                        section headers, terminal output. Everything technical.
                      </div>
                      <div
                        style={{
                          fontFamily: T.font.mono,
                      ...
                      >
                        Monospace. Section labels: 10-11px uppercase tracking
                        0.15em #525252. Code: 12px. Data: 11-13px.
                      </div>
                    </Card>
                  </div>
                </Section>
            ...
            {activeSection === 'components' && (
              <div>
                <DocBlock
                  title="Buttons"
                  description="Three variants. Never border-radius > 8px. Inter font always."
                >
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    ...
                    <BRButton variant="primary" disabled>
                      Disabled
                    </BRButton>
                  </div>
                  <CodeSnippet
                    code={`<BRButton variant="primary">Label</BRButton>
...
<BRButton variant="ghost">Label</BRButton>`}
                ...
                <DocBlock
                  title="Inputs"
                  description="Dark inset background. JetBrains Mono label. Focus border #262626."
                >
                  <BRInput
                    label="Example Label"
                  ...
                  />
                  <CodeSnippet
                    code={`<BRInput label="Email" placeholder="you@example.com" value={val} onChange={setVal} />`}
                  />
                </DocBlock>

                <DocBlock
                  title="Search Bar"
                  description="Magnifying glass prefix. Input + button combined. Used in RoadView, VaultRoad, docs."
                >
                  <BRSearch
                ...
                <DocBlock
                  title="Cards"
                  description="The fundamental container. #131313 bg, #1a1a1a border, 10-14px radius. Optional accent bar."
                >
                  <div
                  ...
                  >
                    ...
                    <Card accentColor={T.gradient} style={{ padding: 20 }}>
                      ...
                      >
                        Card with gradient accent bar at top.
                      </p>
                    </Card>
                    <Card
                      accentColor={T.colors[3]}
                      highlight
                      style={{ padding: 20 }}
                    >
                      <p
                      ...
                      >
                        Highlighted card with single-color accent.
                      </p>
                    </Card>
                  </div>
                </DocBlock>
                ...
                <DocBlock
                  title="Stat Strip"
                  description="Row of KPIs with 1px gap between. Used in every dashboard and landing page."
                >
                  <StatStrip
                    stats={[
                ...
                <DocBlock
                  title="Tags & Badges"
                  description="Mono font, uppercase, subtle border. Optional tier color pip."
                >
                ...
                <DocBlock
                  title="Filter Tabs"
                  description="Horizontal filter row. Active tab gets #1a1a1a background."
                >
                  <FilterTabs
                    options={['all', 'feature', 'improved', 'fixed', 'docs']}
                    active={demoFilter}
                ...
                <DocBlock
                  title="Status Dots"
                  description="Three states: active (#a3a3a3), idle (#404040), offline (#333)."
                >
                  <div
                ...
                <DocBlock
                  title="Progress Bars"
                  description="4px default height. Gray fill. Optional color override."
                >
                  <div
                    style={{
                      display: 'flex',
                ...
                <DocBlock
                  ...
                  description="Used for CLI output, agent status, config display. Dots + title header."
                >
                  <Terminal title="blackroad.status">
                    <div style={{ color: T.text.ghost }}>
                      $ blackroad status
                    </div>
                    <div style={{ color: T.text.dim }}>
                      {' '}
                      agents:{' '}
                      <span style={{ color: T.text.tertiary }}>847 online</span>
                    </div>
                    <div style={{ color: T.text.dim }}>
                      {' '}
                      mesh:{' '}
                    ...
                    <div style={{ color: T.text.dim }}>
                      {' '}
                      uptime:{' '}
                      <span style={{ color: T.text.tertiary }}>99.97%</span>
                    </div>
                  </Terminal>
                </DocBlock>
                ...
                <DocBlock
                  title="Accordion / FAQ"
                  description="Used in pricing FAQ, docs, changelogs. Plus icon rotates 45° on open."
                >
                  <Card>
                    <Accordion
                      question="What is BlackRoad OS?"
                      answer="A distributed AI operating system built on novel mathematical foundations. 20 domains, 150+ subdomains, 1,000 AI agents."
                      isOpen={demoAccordion === 0}
                      onToggle={() =>
                        setDemoAccordion(demoAccordion === 0 ? null : 0)
                      }
                    />
                    <Accordion
                      question="What does 80% creator revenue mean?"
                      answer="When you publish content, sell assets, or earn through the ecosystem, you keep 80%. Compare: Roblox 29%, YouTube 55%, Spotify 0.3%."
                      isOpen={demoAccordion === 1}
                      onToggle={() =>
                        setDemoAccordion(demoAccordion === 1 ? null : 1)
                      }
                    />
                  </Card>
                </DocBlock>
                ...
                <DocBlock
                  title="Spectrum Marks"
                  description="Two variants: bars (nav, footer) and dots (section headers)."
                >
                  <div
                ...
                <DocBlock
                  title="Footer"
                  description="Gradient bar, logo + subtitle, links row. Same on every page."
                >
                  <BRFooter />
                </DocBlock>
              </div>
            ...
            {activeSection === 'patterns' && (
              <div>
                <DocBlock
                  ...
                  description="Every BlackRoad page follows this skeleton:"
                >
                  <CodeSnippet
                    code={`<GradientBar />
...
<BRFooter />`}
                ...
                <DocBlock
                  ...
                  description="Section label → title → description → content. Always this order."
                >
                  <Card style={{ padding: 22 }}>
                    ...
                    >
                      Description paragraph explaining this section. Always
                      Inter, always #737373, always 14-15px.
                    </p>
                    <div
                      style={{
                        fontFamily: T.font.mono,
                ...
                <DocBlock
                  ...
                  description="Items inside a card separated by #141414 borders. Used for transactions, agents, policies, domains."
                >
                  <Card>
                ...
                <DocBlock
                  title="Grid Layouts"
                  description="Auto-fill grids with flexible minimums. Standard pattern for cards, stats, assets."
                >
                  <CodeSnippet
                    code={`// Stat grid
...
gap: 1, background: "#1a1a1a", overflow: "hidden"`}
                ...
                <DocBlock
                  title="Portal Nav Pattern"
                  description="Each portal app uses the same nav structure with tab switching:"
                >
                  <CodeSnippet
                    code={`function Nav({ activeView, setActiveView }) {
                  ...
                  >
                    <Card style={{ padding: 22 }}>
                      ...
                      {[
                        ...
                        >
                          <span
                            style={{ color: T.text.tertiary, flexShrink: 0 }}
                          >
                            ✓
                          </span>{' '}
                          {r}
                    ...
                    <Card style={{ padding: 22 }}>
                      ...
                      {[
                        ...
                        >
                          <span style={{ color: T.text.faint, flexShrink: 0 }}>
                            ✕
                          </span>{' '}
                          {r}
                        </div>
