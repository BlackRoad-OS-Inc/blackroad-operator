...
- **Founder**: Alexa Louise Amundson (sole director, CEO, secretary, treasurer)
...
- Expenses: infrastructure (~$150/mo), domains, Stripe Atlas fee
- Form 1120 can likely be filed as zero-revenue short year
- Consider using TurboTax Business or hiring CPA for first filing
...
- Board Actions (Written Consent in Lieu)
- SS-4, Form 8821
