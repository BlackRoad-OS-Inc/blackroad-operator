...
## 5-AGENT PARALLEL WORK PROTOCOL — READ BEFORE DOING ANYTHING

**CHECK `memory-collaboration.sh inbox` FIRST. Another agent may already be working.**
...
- P4: p4-truth-credibility (fix lies)
- P5-P9: see `memory-infinite-todos.sh show <project-id>`

**RULES:**
1. Claim before work: `memory-collaboration.sh announce "CLAIMING [project] [todo-id] [LANE-X]"`
...
5. View todos: `memory-infinite-todos.sh show p0-first-real-user`
