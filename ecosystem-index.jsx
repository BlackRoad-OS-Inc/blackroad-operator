...
const ORGS = [
  ...
  },
  {
    ...
    repos: [
      'blackroad-os-studio',
      'blackroad-unity-homes',
      'blackroad-os-creator',
      'blackroad-os-gallery',
    ],
  },
  {
...
const FLEET = [
  {
    ...
    emoji: '🌐',
    color: '#00D4FF',
    services: ['Pi-hole', 'PostgreSQL', 'Qdrant', 'Redis', 'nginx'],
    status: 'online',
  },
  {
    name: 'Cecilia',
    ...
    emoji: '🧠',
    color: '#9C27B0',
    services: ['Ollama (16 models)', 'Hailo-8 (26 TOPS)', 'MinIO', 'InfluxDB'],
    status: 'online',
  },
  {
    name: 'Octavia',
    ...
    emoji: '🐙',
    color: '#FF6B2B',
    services: ['Gitea (239 repos)', 'Docker', 'NATS', '15 Workers'],
    status: 'online',
  },
  {
    name: 'Aria',
    ...
    emoji: '🎵',
    color: '#E91E63',
    services: ['Dashboards', 'Monitoring', 'UIs'],
    status: 'offline',
  },
  {
    name: 'Lucidia',
    ...
    emoji: '💡',
    color: '#FFC107',
    services: ['334 web apps', 'PowerDNS', 'Ollama', 'GH Runners'],
    status: 'online',
  },
  {
    name: 'Gematria',
    ...
    emoji: '🔷',
    color: '#4488FF',
    services: ['Caddy TLS (151 domains)', 'Ollama (6 models)', 'PowerDNS'],
    status: 'online',
  },
  {
    name: 'Anastasia',
    ...
    emoji: '☁️',
    color: '#00D4FF',
    services: ['Caddy', 'Domain hosting', 'Failover'],
    status: 'online',
  },
]
...
const PRODUCTS = [
  {
    ...
    status: 'building',
    price: '$20/mo',
    desc: 'AI companion with infinite memory',
  ...
  },
  {
    ...
    status: 'building',
    price: '$9.99/mo',
    desc: 'Accessibility-first education',
  ...
  },
  {
    ...
    status: 'building',
    price: '—',
    desc: 'Verification, not speculation',
    domain: 'roadchain.io',
  },
  {
    name: 'RoadPay',
    ...
    status: 'live',
    price: '2.5% + $0.30',
    desc: 'Sovereign payment processing',
    domain: 'roadpay.blackroad.io',
  },
  {
    name: 'Canvas Studio',
    tier: 'creator',
    status: 'building',
    price: '$29/mo',
    desc: 'Design without design school',
  ...
  },
  {
    ...
    status: 'building',
    price: '$29/mo',
    desc: 'Browser-native 4K editing',
    domain: 'lucidia.studio',
  },
  {
    name: 'Writing Studio',
  ...
  },
  {
    ...
    status: 'planned',
    price: '90%+ rev share',
    desc: 'Where STEM creators thrive',
    domain: 'roadtube.blackroad.io',
  },
  {
    name: 'BackRoad',
    tier: 'social',
    status: 'building',
    price: 'Free',
    desc: 'Social without the algorithm',
  ...
  },
  {
    ...
    status: 'planned',
    price: '$49/mo',
    desc: 'Digital sandbox for physics',
...
const AGENT_OS_LAYERS = [
  {
    layer: 'LLM Gateway',
    repos: 'TensorZero + LiteLLM',
    fn: 'Sub-ms model routing for 30K agents',
    color: COLORS[0],
  },
  {
    layer: 'Agent Runtime',
    repos: 'Mastra (TS) + Rig (Rust/WASM)',
    fn: 'Browser-native agent execution',
    color: COLORS[1],
  },
  {
    layer: 'Agent Memory',
    repos: 'Mem0 + Letta (.af format)',
    fn: 'Per-agent and shared memory',
    color: COLORS[2],
  },
  {
    layer: 'Event Mesh',
    repos: 'Solace patterns + Ractor',
    fn: 'Decoupled, priority channels',
    color: COLORS[3],
  },
  {
    layer: 'Sandboxing',
    repos: 'workerd / rquickjs + Extism',
    fn: 'Isolation for 30K concurrent agents',
    color: COLORS[4],
  },
  {
    layer: 'Component Model',
    repos: 'jco + wasm_component_layer',
    fn: 'Cross-language agent interfaces (WIT)',
    color: COLORS[5],
  },
  {
    layer: 'Storage',
    repos: 'sql.js + opfs-tools',
    fn: 'Persistent browser-native state',
    color: COLORS[0],
  },
  {
    layer: 'P2P Mesh',
    repos: 'Rings Network',
    fn: 'Decentralized agent routing',
    color: COLORS[1],
  },
  {
    layer: 'Scheduling',
    repos: 'Tokio + Crossbeam primitives',
    fn: 'Work-stealing agent scheduler',
    color: COLORS[2],
  },
  {
    layer: 'Security',
    repos: 'seL4 capability + Tock capsule',
    fn: 'Agent permissions and isolation',
    color: COLORS[3],
  },
  {
    layer: 'Build System',
    repos: 'Moon + Turborepo + mise',
    fn: 'Polyglot monorepo orchestration',
    color: COLORS[4],
  },
  {
    layer: 'Dev Portal',
    repos: 'Backstage + Ratatui dashboards',
    fn: 'Mission control and observability',
    color: COLORS[5],
  },
]
...
const SOVEREIGNTY_STACK = [
  { service: 'Git', self: 'Gitea · Octavia', replaces: 'GitHub', repos: '239' },
  {
    ...
    self: 'Ollama · 4 nodes',
    replaces: 'OpenAI / Anthropic',
    repos: '52 TOPS',
  },
  {
    service: 'Workers',
    self: 'workerd · Octavia :9001-9015',
    replaces: 'CF Workers',
    repos: '15',
  },
  {
  ...
  {
    service: 'DNS',
    self: 'PowerDNS · Lucidia + Gematria',
    replaces: 'Cloudflare DNS',
    repos: '151 records',
  },
  {
    service: 'PaaS',
    self: 'Deploy API · Octavia :3500',
    replaces: 'Railway / Heroku',
    repos: '—',
  },
  {
    service: 'Database',
    self: 'PostgreSQL · 3 nodes',
    replaces: 'CF D1 / Supabase',
    repos: '—',
  },
  ...
  {
    service: 'Chat',
    self: 'RoundTrip (D1) + chat.blackroad.io',
    replaces: 'Slack',
    repos: '69 agents',
  },
  {
    service: 'CI/CD',
    self: 'Gitea Actions + act_runner',
...
const DOMAINS = [
  {
    domain: 'blackroad.io',
    purpose: 'Main OS & product site',
    tier: 'core',
    layer: 'Experience',
  },
  {
    domain: 'blackroad.systems',
    purpose: 'Internal ops, infra, APIs',
    tier: 'core',
    layer: 'Governance',
  },
  {
    domain: 'blackroad.network',
    purpose: 'Agent & device mesh',
    tier: 'core',
    layer: 'Infrastructure',
  },
  {
    domain: 'blackroadinc.us',
    purpose: 'Legal / corporate entity',
    tier: 'core',
    layer: 'Corporate',
  },
  {
    domain: 'blackroad.me',
    purpose: 'Founder personal hub',
    tier: 'core',
    layer: 'Personal',
  },
  {
    domain: 'blackroad.company',
    purpose: 'Public corporate site',
    tier: 'core',
    layer: 'Corporate',
  },
  {
    domain: 'lucidia.earth',
    purpose: 'Lucidia AI platform',
    tier: 'product',
    layer: 'Experience',
  },
  {
    domain: 'lucidia.studio',
    purpose: 'Creator tools & Unity homes',
    tier: 'product',
    layer: 'Experience',
  },
  {
    domain: 'roadchain.io',
    purpose: 'Blockchain / ledger protocol',
    tier: 'product',
    layer: 'Product',
  },
  {
    domain: 'roadcoin.io',
    purpose: 'Token / economic layer',
    tier: 'product',
    layer: 'Product',
  },
  {
    domain: 'blackroadai.com',
    purpose: 'AI-focused marketing',
    tier: 'product',
    layer: 'Experience',
  },
  {
    domain: 'blackboxprogramming.io',
    purpose: 'Developer / creator brand',
    tier: 'product',
    layer: 'Product',
  },
  {
    domain: 'blackroadquantum.com',
    purpose: 'Quantum research hub',
    tier: 'quantum',
    layer: 'Research',
  },
  {
    domain: 'blackroadquantum.info',
    purpose: 'Quantum education',
    tier: 'quantum',
    layer: 'Research',
  },
  {
    domain: 'blackroadquantum.net',
    purpose: 'Quantum network infra',
    tier: 'quantum',
    layer: 'Research',
  },
  {
    domain: 'blackroadquantum.shop',
    purpose: 'Merch / products',
    tier: 'quantum',
    layer: 'Commerce',
  },
  {
  ...
  },
  {
    ...
    purpose: 'Quantum identity portal',
    tier: 'quantum',
    layer: 'Research',
  },
  {
    domain: 'lucidiaqi.com',
    purpose: 'Lucidia + QI hybrid',
    tier: 'quantum',
    layer: 'Research',
  },
  {
    domain: 'aliceqi.com',
    purpose: 'Alice agent identity',
    tier: 'agent',
    layer: 'Agent',
  },
]
      ...
      >
        <div style={{ display: 'flex', gap: 2 }}>
          {COLORS.map((c) => (
            <div
              key={c}
              style={{ width: 3, height: 14, borderRadius: 2, background: c }}
            />
          ))}
        </div>
        <span
  ...
  return (
    <section style={{ padding: '56px 20px 48px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          The complete BlackRoad ecosystem — 16 GitHub organizations, 20
          Cloudflare domains, and the architecture that connects them all.
          Intelligent turtles all the way down.
        </p>
...
function OrgsSection() {
  ...
  const filtered =
    filter === 'all' ? ORGS : ORGS.filter((o) => o.tier === filter)
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {filtered.map((org, i) => (
            ...
            >
              <button
                onClick={() =>
                  setExpandedOrg(expandedOrg === org.name ? null : org.name)
                }
                style={{
                  width: '100%',
                  textAlign: 'left',
              ...
              >
                <div
                  style={{
                    ...
                    height: 24,
                    borderRadius: 2,
                    background: TIER_COLORS[org.tier],
                    flexShrink: 0,
                    marginTop: 2,
                  }}
                />
                ...
                <span
                  style={{
                    ...
                    color: '#333',
                    transform:
                      expandedOrg === org.name ? 'rotate(45deg)' : 'none',
              ...
              {expandedOrg === org.name && (
                <div style={{ padding: '0 20px 16px' }}>
                  <div
                    style={{ borderTop: '1px solid #1a1a1a', paddingTop: 14 }}
                  >
                    <div
                      style={{
                        fontFamily: "'JetBrains Mono', monospace",
...
function DomainsSection() {
  ...
  const filtered =
    tierFilter === 'all'
      ? DOMAINS
      : DOMAINS.filter((d) => d.tier === tierFilter)
        ...
        >
          ...
          >
            ...
            <div style={{ color: '#d4d4d4', paddingLeft: 18 }}>
              <span style={{ color: COLORS[1] }}>■</span> BlackRoad-OS-Inc{' '}
              <span style={{ color: '#333' }}>← enterprise root</span>
            </div>
            <div style={{ color: '#a3a3a3', paddingLeft: 36 }}>
              <span style={{ color: COLORS[2] }}>■</span> BlackRoad-OS{' '}
              <span style={{ color: '#333' }}>← coordinates all orgs</span>
            </div>

            <div style={{ color: '#404040', paddingLeft: 36, marginTop: 8 }}>
              {'# Product orgs'}
            </div>
            {[
              'BlackRoad-AI',
              ...
              <div key={n} style={{ color: '#737373', paddingLeft: 54 }}>
                ├── {n}
              </div>
            ))}
            ...
            <div style={{ color: '#404040', marginTop: 16 }}>
              {'# Domain layers'}
            </div>
            <div style={{ color: '#a3a3a3', paddingLeft: 18 }}>
              <span style={{ color: COLORS[0] }}>■</span> Experience {'  '}
              *.blackroad.io · *.lucidia.earth · *.lucidia.studio
            </div>
            <div style={{ color: '#a3a3a3', paddingLeft: 18 }}>
              <span style={{ color: COLORS[2] }}>■</span> Governance {'  '}
              *.blackroad.systems
            </div>
            <div style={{ color: '#a3a3a3', paddingLeft: 18 }}>
              <span style={{ color: COLORS[3] }}>■</span> Infra {'       '}
              *.blackroad.network
            </div>
            <div style={{ color: '#a3a3a3', paddingLeft: 18 }}>
              <span style={{ color: COLORS[5] }}>■</span> Data {'        '}
              internal services
            </div>
          ...
          {[
            {
              layer: 'Experience',
              color: COLORS[0],
              orgs: ['BlackRoad-OS', 'BlackRoad-Studio', 'BlackRoad-AI'],
              domains: [
                'blackroad.io',
                'lucidia.earth',
                'lucidia.studio',
            ...
            },
            {
              ...
              domains: ['blackroadinc.us', 'blackroad.company', 'blackroad.me'],
            },
          ].map((l) => (
            <div
              key={l.layer}
  ...
  return (
    <section id="fleet" style={{ padding: '48px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          5 Raspberry Pis + 2 DigitalOcean droplets. 52 TOPS. WireGuard mesh
          12/12. $136/month.
        </p>
  ...
  return (
    <section id="sovereignty" style={{ padding: '48px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          $925 one-time hardware vs $2,220–8,400/yr cloud. Break-even: 6.2
          months.
        </p>
        ...
        >
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: '1fr 2fr 1.5fr 80px',
              gap: 0,
              padding: '10px 18px',
              borderBottom: '1px solid #1a1a1a',
            }}
  ...
  return (
    <section id="products" style={{ padding: '48px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          {tiers
            .filter((t) => t === 'all' || PRODUCTS.some((p) => p.tier === t))
            .map((t) => (
              <button
                key={t}
                onClick={() => setFilter(t)}
  ...
  return (
    <section id="agent-os" style={{ padding: '48px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          rquickjs at 210KB per interpreter makes it physically possible. 30K
          agents = 6.3GB. Actor/event-mesh is the convergence.
        </p>
    ...
    <section id="math" style={{ padding: '48px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          ...
          >
            G(n) = n<sup style={{ fontSize: '0.7em' }}>(n+1)</sup> / (n+1)
            <sup style={{ fontSize: '0.7em' }}>n</sup>
          </div>
          <div
            style={{
              display: 'flex',
          ...
          >
            n / (1 + 1/n)<sup>n</sup> → n/e + 1/(2e) + O(1/n)
            <br />
            <span style={{ color: '#404040' }}>
              The 1/(2e) is the irreducible gap.
            </span>
          </div>
        </div>
      </div>
