...
def _sources_block(ctx: str) -> str:
    if ctx:
        return "AVAILABLE SOURCES:\n" + ctx
    return "No sources provided — assess from your training data."


def cross_verify_prompt(claim: str, sources: Optional[List[str]] = None) -> str:
