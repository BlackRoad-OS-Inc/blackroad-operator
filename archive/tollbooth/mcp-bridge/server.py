...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-tollbooth-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "tollbooth"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="tollbooth MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "tollbooth MCP Bridge", "host": platform.node()}
