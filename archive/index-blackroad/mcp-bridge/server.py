...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-index-blackroad-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "index-blackroad"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="index-blackroad MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "index-blackroad MCP Bridge", "host": platform.node()}
