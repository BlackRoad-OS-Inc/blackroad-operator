...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-prism-blackroad-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "prism-blackroad"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="prism-blackroad MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "prism-blackroad MCP Bridge", "host": platform.node()}
