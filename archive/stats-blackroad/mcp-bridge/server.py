...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-stats-blackroad-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "stats-blackroad"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="stats-blackroad MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "stats-blackroad MCP Bridge", "host": platform.node()}
