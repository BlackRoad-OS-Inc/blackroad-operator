...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-portal-blackroad-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "portal-blackroad"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="portal-blackroad MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "portal-blackroad MCP Bridge", "host": platform.node()}
