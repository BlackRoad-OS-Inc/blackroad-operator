...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-images-blackroad-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "images-blackroad"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="images-blackroad MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "images-blackroad MCP Bridge", "host": platform.node()}
