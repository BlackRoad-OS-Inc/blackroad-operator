...
- This checks: [MEMORY] [LIVE] [COLLABORATION] [BLACKROAD OS] [GREENLIGHT] [TODOS]
```
...
2. ✅ Check [BLACKROAD OS] for existing solutions (might already exist!)
...
# BlackRoad OS search
~/blackroad-blackroad os-verification-suite.sh search <term>
...
- `~/blackroad-blackroad os-verification-suite.sh`
...
$ ~/blackroad-blackroad os-verification-suite.sh search "visual docs"
...
3. **Check before building**: Search BLACKROAD OS first (avoid duplicate work)
