...
Sub Category: receiving account statements to provide for form 1099

Form: RMD Change Request

Action Required: clients need to sign

User Action: click “new business”

Expectations: client will receive X in 5 days

Limitations: if a client doesn’t double check the date
...
Lorem ipsum dolor sit amet, interdum fermentum integer, ac adipiscing neque suscipit. Et molestie sit amet tincidunt sed in, dictum viverra pharetra convallis pellentesque, a luctus nisl aliquet amet neque, justo egestas leo, ut magna.
