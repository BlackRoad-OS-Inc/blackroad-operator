...
> BlackRoad OS fork of Portainer CE
> Portainer fork — Docker container management for BlackRoad fleet

## Priority Tasks

- [ ] [RC] Integrate backroad with RoundTrip hub (roundtrip.blackroad.io) for agent coordination
- [ ] [RC] Register BackRoad Agent in the BlackRoad Agent OS roster (~/.blackroad-agents/)
- [ ] [RC] Deploy backroad to Pi fleet node: Aria (.98)
...
- [ ] [RC] Add NLP intent triggers: 'manage containers' / 'docker status'
- [ ] [RC] Create systemd service file for auto-start on Aria (.98)
...
## Upstream Sync
- [ ] Track upstream Portainer CE releases
