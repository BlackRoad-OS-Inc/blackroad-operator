        ...
        >
          ...
          <div
            className={`absolute w-2 h-2 bg-[var(--bg-card)] border-r border-b border-[var(--border)] transform rotate-45 ${
              position === 'top'
                ? 'bottom-[-5px] left-1/2 -translate-x-1/2 border-l border-t'
                : position === 'bottom'
                  ? 'top-[-5px] left-1/2 -translate-x-1/2 border-r border-b'
                  : position === 'left'
                    ? 'right-[-5px] top-1/2 -translate-y-1/2 border-t border-l'
