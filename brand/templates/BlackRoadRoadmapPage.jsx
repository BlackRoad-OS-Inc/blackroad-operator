...
const METRICS = [
  ...
  { label: "Agents — v2.0",     value: "67",  sub: "target Q4 2026",                  color: "#00D4FF" },
            ...
            <section style={{ padding: mobile ? "40px 0 64px" : "56px 0 80px" }}>
              <Section>
                ...
                <p style={{ fontFamily: inter, fontSize: 13, color: "#2a2a2a", lineHeight: 1.75, maxWidth: 500, marginBottom: 36 }}>
                  Six milestone releases across 2026 — from core scaffold through 67-agent deployment. Click any milestone to expand deliverables.
                </p>
              </Section>
          ...
          {activeTab === "Vision" && (
            <section style={{ padding: mobile ? "40px 0 64px" : "56px 0 80px" }}>
              ...
              <Section>
                ...
                <SectionTitle>1,000 agents. Then 67.</SectionTitle>
                <p style={{ fontFamily: inter, fontSize: 13, color: "#2a2a2a", lineHeight: 1.75, maxWidth: 520, marginBottom: 36 }}>
