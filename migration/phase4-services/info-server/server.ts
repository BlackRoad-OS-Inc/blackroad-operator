...
> = {
  'blackroad-os-core': {
    name: 'Core Library',
    type: 'library',
    description: 'Shared types, contracts, primitives',
    status: 'active',
  },
  'blackroad-os-helper': {
    name: 'Helper Service',
    type: 'service',
    description: 'Assistant and helper agent',
    status: 'active',
  },
  'blackroad-os-docs': {
    name: 'Documentation',
  ...
  'blackroad-cli': {
    ...
    status: 'active',
    repo: 'BlackRoad-OS/blackroad-cli',
  },
  'blackroad-agents': {
    name: 'Agent System',
    type: 'service',
  ...
  'containers-template': {
    ...
    type: 'template',
    description: 'Docker/K8s templates',
    status: 'active',
  },
  'lucidia-core': {
    name: 'Lucidia Core',
  ...
  'blackroad-pi-ops': {
    name: 'Pi Operations',
    type: 'iot',
    description: 'Raspberry Pi management',
    status: 'active',
  },
  'blackroad-tools': {
    name: 'Tools',
    type: 'tools',
    description: 'CRM/ERP adapters',
    status: 'active',
  },
  'blackroad-os-metaverse': {
    name: 'Metaverse',
    type: 'app',
    description: '3D world visualization',
    status: 'active',
  },
  'blackroad-os-pitstop': {
    name: 'Pitstop',
    type: 'portal',
    description: 'Portal and quick links hub',
    status: 'active',
  },
  'blackroad-os-roadworld': {
    name: 'RoadWorld',
    type: 'app',
    description: 'World simulation services',
    status: 'active',
  },
  ...
  'blackroad-os-mesh': {
    name: 'Mesh',
    type: 'service',
    description: 'WebSocket mesh network',
    status: 'active',
  },
}
...
app.get('*', (c) => {
  ...
  const matchedKey = Object.keys(SERVICES).find(
    (k) =>
      k.replace('blackroad-', '').replace('os-', '').includes(sub) ||
      sub.includes(k.replace('blackroad-', '')),
  )
