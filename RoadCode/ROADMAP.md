# ROADMAP — BlackRoad-OS-Inc/RoadCode (MASTER)

> This is the canonical roadmap. All sub-org roadmaps align to this.
> Updated: 2026-03-21
...
- [x] All domain repos: PROPRIETARY license, protected main branch
- [x] blackroad-operator with 400+ scripts, 100+ tools
- [x] 7/7 nodes online (5 Pis + 2 droplets)
- [x] 279 websites on Gematria, 114 Caddy domains
- [x] RoundTrip: 69+ agents
...
- [ ] GoDaddy NS → PowerDNS (self-hosted DNS)
...
- [ ] IPFS hosting for static assets
- [ ] mesh.js browser SDK
