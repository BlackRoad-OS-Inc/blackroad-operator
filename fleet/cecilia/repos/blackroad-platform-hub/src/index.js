    ...
    try {
      ...
      if (path === '/api/platform/inventory') {
        return json({
          ...
          agents: { total: 31000, registry: 'Apollo D1', cores: ['aria', 'lucidia', 'silas', 'cecilia', 'cadence', 'alice'] }
        }, corsHeaders);
      }
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    h1 {
      font-size: 2.5rem;
      background: linear-gradient(90deg, #F5A623 0%, #FF1D6C 50%, #2979FF 100%);
    ...
    .card:nth-child(1) .stat { color: #F5A623; }
    .card:nth-child(2) .stat { color: #FF1D6C; }
    .card:nth-child(3) .stat { color: #2979FF; }
    .card:nth-child(4) .stat { color: #9C27B0; }
    ...
    .refresh-btn {
      background: linear-gradient(90deg, #F5A623 0%, #FF1D6C 100%);
      border: none;
      color: #000;
      font-weight: 600;
    ...
    .error { color: #FF1D6C; font-size: 0.9rem; }
    .timestamp { text-align: center; color: #444; font-size: 0.85rem; margin-top: 2rem; }
    .api-links {
      display: flex;
      gap: 1rem;
      flex-wrap: wrap;
    ...
    .api-link:hover { background: rgba(41, 121, 255, 0.2); }
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="grid">
      ...
      <div class="card">
        ...
        <div class="stat">31K</div>
        <div class="stat-label">Apollo Agent Registry</div>
      </div>
