...
const API_BASE = process.env.BLACKROAD_API || 'https://blackroad-tools.blackroad.workers.dev';
...
Environment:
  BLACKROAD_API    API base URL (default: https://blackroad-tools.blackroad.workers.dev)
`);
  },
};
