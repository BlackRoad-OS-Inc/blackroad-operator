// data.blackroad.io — Data Platform
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/orgs/BlackRoad-Labs';
...
<head>
  ...
  <title>Data Platform — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">data.blackroad.io</div>
    <h1>Data Platform</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'data.blackroad.io', description: 'Data Platform', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'data-blackroadio',
