// edge.blackroad.io — Edge Computing
...
<head>
  ...
  <title>Edge Computing — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">edge.blackroad.io</div>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'edge.blackroad.io', description: 'Edge Computing', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'edge-blackroadio',
