...
<head>
  ...
  <title>Systems Dashboard — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">blackroad.systems</div>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'blackroad.systems', description: 'Systems Dashboard', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'blackroad-systems',
