// cli.blackroad.io — CLI Tools
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/repos/BlackRoad-OS-Inc/blackroad-cli';
...
<head>
  ...
  <title>CLI Tools — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">cli.blackroad.io</div>
    <h1>CLI Tools</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'cli.blackroad.io', description: 'CLI Tools', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'cli-blackroadio',
