// algorithms.blackroad.io — AI Algorithms
...
<head>
  ...
  <title>AI Algorithms — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">algorithms.blackroad.io</div>
    <h1>AI Algorithms</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'algorithms.blackroad.io', description: 'AI Algorithms', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'algorithms-blackroadio',
