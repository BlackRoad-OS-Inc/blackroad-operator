// hardware.blackroad.io — Hardware & IoT
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/repos/BlackRoad-OS-Inc/blackroad-hardware';
...
<head>
  ...
  <title>Hardware & IoT — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">hardware.blackroad.io</div>
    <h1>Hardware & IoT</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'hardware.blackroad.io', description: 'Hardware & IoT', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'hardware-blackroadio',
