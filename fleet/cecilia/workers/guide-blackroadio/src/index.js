// guide.blackroad.io — Getting Started Guide
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/repos/BlackRoad-OS-Inc/blackroad-docs/readme';
...
<head>
  ...
  <title>Getting Started Guide — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">guide.blackroad.io</div>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'guide.blackroad.io', description: 'Getting Started Guide', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'guide-blackroadio',
