// about.blackroad.io — About BlackRoad OS
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/orgs/BlackRoad-OS-Inc';
...
<head>
  ...
  <title>About BlackRoad OS — BlackRoad OS</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .subdomain { font-family: 'Courier New', monospace; font-size: 1rem; color: #FF1D6C; margin-bottom: 2rem; }
    .stats { display: flex; gap: 3rem; justify-content: center; flex-wrap: wrap; }
    .stat { text-align: center; }
    .stat .val { font-size: 2.5rem; font-weight: 800; color: #FF1D6C; }
    ...
    .data-card h3 { color: #FF1D6C; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 0.75rem; }
    ...
    .btn-primary { background: #FF1D6C; color: #000; }
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">about.blackroad.io</div>
    <h1>About BlackRoad OS</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'about.blackroad.io', description: 'About BlackRoad OS', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'about-blackroadio',
