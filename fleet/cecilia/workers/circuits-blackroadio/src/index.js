// circuits.blackroad.io — Hardware Circuits
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/orgs/BlackRoad-Hardware';
...
<head>
  ...
  <title>Hardware Circuits — BlackRoad OS</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .subdomain { font-family: 'Courier New', monospace; font-size: 1rem; color: #F5A623; margin-bottom: 2rem; }
    .stats { display: flex; gap: 3rem; justify-content: center; flex-wrap: wrap; }
    .stat { text-align: center; }
    .stat .val { font-size: 2.5rem; font-weight: 800; color: #F5A623; }
    ...
    .data-card h3 { color: #F5A623; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 0.75rem; }
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">circuits.blackroad.io</div>
    <h1>Hardware Circuits</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'circuits.blackroad.io', description: 'Hardware Circuits', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'circuits-blackroadio',
