// explorer.blackroad.io — Repo Explorer
// BlackRoad OS, Inc. — All Rights Reserved

const DATA_URL = 'https://api.github.com/orgs/BlackRoad-OS-Inc/repos?per_page=10';
...
<head>
  ...
  <title>Repo Explorer — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">explorer.blackroad.io</div>
    <h1>Repo Explorer</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'explorer.blackroad.io', description: 'Repo Explorer', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
  ...
  async fetch(request, env, ctx) {
    ...
    return new Response(html, {
      headers: {
        ...
        'X-BlackRoad-Worker': 'explorer-blackroadio',
